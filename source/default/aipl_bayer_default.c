 ...
 *  STATIC PROTOTYPES
 **********************/
static INLINE void aipl_bayer_to_rgb(uint8_t* rgb0, uint8_t* rgb1,
...
aipl_error_t aipl_bayer_decoding_default(const void *input, void *output,
                                         uint32_t pitch,
...
aipl_error_t aipl_bayer_decoding_img_default(const void *input,
                                             aipl_image_t *output,
                                             uint32_t pitch,
                                             aipl_bayer_filter_t filter)
{
    ...
    return aipl_bayer_decoding_default(input, output->data, pitch,
                                       output->width, output->height,
                                       filter, output->format);
}

aipl_error_t aipl_bayer_decoding_alpha8_default(const void* input,
                                                void* output,
                                                uint32_t pitch,
                                                uint32_t width,
                                                uint32_t height,
...
aipl_error_t aipl_bayer_decoding_argb8888_default(const void* input,
                                                  void* output,
                                                  uint32_t pitch,
                                                  uint32_t width,
                                                  uint32_t height,
...
aipl_error_t aipl_bayer_decoding_argb4444_default(const void* input,
                                                  void* output,
                                                  uint32_t pitch,
                                                  uint32_t width,
                                                  uint32_t height,
...
aipl_error_t aipl_bayer_decoding_argb1555_default(const void* input,
                                                  void* output,
                                                  uint32_t pitch,
                                                  uint32_t width,
                                                  uint32_t height,
...
aipl_error_t aipl_bayer_decoding_rgba8888_default(const void* input,
                                                  void* output,
                                                  uint32_t pitch,
                                                  uint32_t width,
                                                  uint32_t height,
...
aipl_error_t aipl_bayer_decoding_rgba4444_default(const void* input,
                                                  void* output,
                                                  uint32_t pitch,
                                                  uint32_t width,
                                                  uint32_t height,
...
aipl_error_t aipl_bayer_decoding_rgba5551_default(const void* input,
                                                  void* output,
                                                  uint32_t pitch,
                                                  uint32_t width,
                                                  uint32_t height,
...
aipl_error_t aipl_bayer_decoding_rgb888_default(const void* input,
                                                void* output,
                                                uint32_t pitch,
                                                uint32_t width,
                                                uint32_t height,
...
aipl_error_t aipl_bayer_decoding_bgr888_default(const void* input,
                                                void* output,
                                                uint32_t pitch,
                                                uint32_t width,
                                                uint32_t height,
...
aipl_error_t aipl_bayer_decoding_rgb565_default(const void* input,
                                                void* output,
                                                uint32_t pitch,
                                                uint32_t width,
                                                uint32_t height,
                                                aipl_bayer_filter_t filter)
{
    ...
    memcpy((aipl_rgb565_px_t*)output + (height - 1) * width,
           (aipl_rgb565_px_t*)output + (height - 2) * width,
           width * sizeof(aipl_rgb565_px_t));

    return AIPL_ERR_OK;
}

aipl_error_t aipl_bayer_decoding_yv12_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
...
aipl_error_t aipl_bayer_decoding_i420_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
...
aipl_error_t aipl_bayer_decoding_i422_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
    ...
    for (uint32_t i = 0; i < height - 1; ++i)
    {
        ...
        for (uint32_t j = 0; j < width; j += 2)
        {
            ...
            aipl_cnvt_px_rgb_to_yuv(y_dst + j,
                                    u_dst + j / 2,
                                    v_dst + j / 2,
                                    rgb0[0], rgb0[1], rgb0[2]);
            aipl_cnvt_px_rgb_to_yuv_y(y_dst + j + 1,
...
aipl_error_t aipl_bayer_decoding_i444_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
    ...
    for (uint32_t i = 0; i < height - 1; ++i)
    {
        ...
        for (uint32_t j = 0; j < width; j += 2)
        {
            ...
            aipl_cnvt_px_rgb_to_yuv(y_dst + j,
                                    ...
                                    v_dst + j,
                                    rgb0[0], rgb0[1], rgb0[2]);
            aipl_cnvt_px_rgb_to_yuv(y_dst + j + 1,
                                    u_dst + j + 1,
                                    v_dst + j + 1,
                                    rgb1[0], rgb1[1], rgb1[2]);
        }
...
aipl_error_t aipl_bayer_decoding_i400_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
...
aipl_error_t aipl_bayer_decoding_nv12_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
...
aipl_error_t aipl_bayer_decoding_nv21_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
...
aipl_error_t aipl_bayer_decoding_yuy2_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
...
aipl_error_t aipl_bayer_decoding_uyvy_default(const void* input, void* output,
                                              uint32_t pitch,
                                              uint32_t width, uint32_t height,
                                              aipl_bayer_filter_t filter)
{
                                     ...
                                     uint32_t idx)
{
    ...
    rgb0[1] = (tile->red_src[blue_col_idx]
               + tile->blue_src[red_col_idx]) >> 1;
    ...
    rgb1[1] = (tile->red_src[blue_col_idx + red_col_2dx]
               + tile->blue_src[red_col_idx + blue_col_2dx]) >> 1;
                                                   ...
                                                   aipl_bayer_filter_t filter)
{
    ...
    for (uint32_t i = 0; i < height - 1; ++i)
    {
        ...
        for (uint32_t j = 0; j < width; j += 2)
        {
            ...
            {
                aipl_cnvt_px_rgb_to_yuv_y(y_dst + j,
                                          rgb0[0], rgb0[1], rgb0[2]);
            }
                                                   ...
                                                   aipl_bayer_filter_t filter)
{
    ...
    for (uint32_t i = 0; i < height - 1; ++i)
    {
        ...
        for (uint32_t j = 0; j < width; j += 2)
        {
            ...
            aipl_cnvt_px_rgb_to_yuv(y_dst + j * 2,
                                    u_dst + j * 2,
                                    v_dst + j * 2,
                                    rgb0[0], rgb0[1], rgb0[2]);
            aipl_cnvt_px_rgb_to_yuv_y(y_dst + (j + 1) * 2,
                                      rgb1[0], rgb1[1], rgb1[2]);
