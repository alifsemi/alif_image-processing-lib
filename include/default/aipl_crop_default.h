...
/******************************************************************************
 * @file    aipl_crop_default.h
 * @brief   Default crop function definitions
 *
******************************************************************************/

#ifndef AIPL_CROP_DEFAULT_H
#define AIPL_CROP_DEFAULT_H
 ...
 * @return error code
 */
aipl_error_t aipl_crop_default(const void* input, void* output,
                               uint32_t pitch,
 ...
 * @return error code
 */
aipl_error_t aipl_crop_img_default(const aipl_image_t* input,
                                   aipl_image_t* output,
                                   uint32_t left, uint32_t top,
                                   uint32_t right, uint32_t bottom);
